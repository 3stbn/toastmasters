      ...
      <div className="animate-fade-in flex flex-col gap-3 sm:flex-row" style={{ animationDelay: '50ms' }}>
        ...
        <div className="flex gap-3">
          <select
            ...
            className="flex-1 appearance-none rounded-xl border border-gray-200 bg-white px-4 py-3 pr-10 text-base shadow-sm transition-all duration-200 focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-100 sm:flex-initial"
